 ...
 */
public class SupportFragment extends com.trello.rxlifecycle.components.support.RxFragment
  ...
  @Override public void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    if (savedInstanceState == null) {
      ...
      mFragmentAnimator =
          savedInstanceState.getParcelable(Fragmentation.FRAGMENTATION_STATE_SAVE_ANIMATOR);
  ...
  @IntDef({ STANDARD, SINGLETOP, SINGLETASK }) @Retention(RetentionPolicy.SOURCE)
  ...
  @Override public void loadRootFragment(int containerId, SupportFragment toFragment) {
    mFragmentation.loadRootTransaction(getChildFragmentManager(), containerId, toFragment);
  }

  @Override public void replaceLoadRootFragment(int containerId, SupportFragment toFragment,
      boolean addToBack) {
    mFragmentation.replaceLoadRootTransaction(getChildFragmentManager(), containerId, toFragment,
        addToBack);
  }

  @Override public void loadMultipleRootFragment(int containerId, int showPosition,
      SupportFragment... toFragments) {
    mFragmentation.loadMultipleRootTransaction(getChildFragmentManager(), containerId, showPosition,
        toFragments);
  }
  ...
  @Override public void start(SupportFragment toFragment) {
    start(toFragment, STANDARD);
  }

  @Override public void start(final SupportFragment toFragment, @LaunchMode final int launchMode) {
    mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, launchMode,
        Fragmentation.TYPE_ADD, null, null);
  }

  @Override public void startForResult(SupportFragment toFragment, int requestCode) {
    mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, requestCode,
        STANDARD, Fragmentation.TYPE_ADD_RESULT, null, null);
  }

  @Override public void startWithPop(SupportFragment toFragment) {
    mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, STANDARD,
        Fragmentation.TYPE_ADD_WITH_POP, null, null);
  }

  @Override
  public void startWithSharedElement(SupportFragment toFragment, View sharedElement, String name) {
    mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, 0, STANDARD,
        Fragmentation.TYPE_ADD, sharedElement, name);
  }

  @Override public void startForResultWithSharedElement(SupportFragment toFragment, int requestCode,
      View sharedElement, String name) {
    mFragmentation.dispatchStartTransaction(getFragmentManager(), this, toFragment, requestCode,
        STANDARD, Fragmentation.TYPE_ADD_RESULT, sharedElement, name);
  }

  @Override public void replaceFragment(SupportFragment toFragment, boolean addToBack) {
   ...
   */
  @Override public SupportFragment getTopFragment() {
   ...
   */
  @Override public SupportFragment getTopChildFragment() {
   ...
   */
  @Override public SupportFragment getPreFragment() {
   ...
   */
  @Override public <T extends SupportFragment> T findFragment(Class<T> fragmentClass) {
   ...
   */
  @Override public <T extends SupportFragment> T findChildFragment(Class<T> fragmentClass) {
   ...
   */
  @Override public void popTo(Class<?> fragmentClass, boolean includeSelf) {
   ...
   * 子栈内
   */
  @Override public void popToChild(Class<?> fragmentClass, boolean includeSelf) {
  ...
  @Override public void popTo(Class<?> fragmentClass, boolean includeSelf,
    ...
    mFragmentation.popTo(fragmentClass, includeSelf, afterPopTransactionRunnable,
        getFragmentManager());
  }
